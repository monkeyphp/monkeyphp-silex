...
/* message/index.twig */
class __TwigTemplate_610efa3a57efa3f3edecf9ed4e43f692f960061fac92ba91c1ba79b27201edd6 extends Twig_Template
{
...
<section>
    ...
    ";
        // line 8
        echo         $this->env->getExtension('form')->renderer->renderBlock($this->getContext($context, "form"), 'form_start', array("action" => $this->env->getExtension('routing')->getPath("message_index")));
        echo "
